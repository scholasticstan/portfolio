...
export const offer = [
  { title: 'I ship whole products, not just screens', body: '<a href="/projects/payroid/">Payroid</a> is a live fintech I founded and built: customer app, operator console and Flutter app, about 94k lines. The <a href="/projects/bethadel-media/">Bethadel Media site</a> went from brief to launch in a week. <a href="/projects/linkbolt/">LinkBolt</a> has a UI, server actions, a Postgres schema and a JSON API.' },
  { title: 'Tests and CI from the first commit, every time', body: '<a href="https://github.com/scholasticstan/linkbolt/actions" target="_blank" rel="noopener">33 tests</a>, unit and integration, run in GitHub Actions on every push with a real Postgres service. Lint, typecheck, build. Nothing merges red.' },
  { title: 'Performance decisions I can explain in review', body: 'Redirects answer from a bounded cache and record the click after the response is sent. I can tell you why it is a 302 and not a 301, and what that costs.' },
  { title: 'I know what the framework is hiding', body: 'I wrote a Unix shell and printf in C during ALX. When a React abstraction leaks, I know what it is hiding.' },
  { title: 'Code and pull requests you can read cold', body: 'Small commits, comments that say why, READMEs that list the trade-offs. The next engineer should not need me in the room.' },
  { title: 'I notice what users notice', body: '<a href="/projects/payroid/">Payroid</a> locks the rate at submit and refuses a KYC backdoor for app reviewers. <a href="/projects/linkbolt/">LinkBolt</a> counts bots separately and hashes visitors instead of storing IPs. Details a user notices.' },
];
